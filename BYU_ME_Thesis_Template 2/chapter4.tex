...
\section{Overview}
In this chapter, the model described in Chapter 3 is applied to evaluate the relative systemic
...
\begin{figure}
  \centering
{\centering \includegraphics[width=0.65\linewidth]{figures/chapter4/tooelemapwithcone.png}
}
