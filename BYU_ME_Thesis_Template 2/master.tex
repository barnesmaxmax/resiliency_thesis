...
\byustylesetup{%
    ...
    deptname          = Department of Civil and Construction Engineering,
   ...
   % nolistoftables = true,     % Don't show the List of Tables
    ...
    keywords = {resilience, logsum, logit model, choice model, mode choice,
    destination choice, transportation model, transportation planning } % Enter your keywords
...
%%%%%%%%%%%%% begin Bibliography %%%%%%%%%%%%%%%%%
\cleardoublepage
\bibliographystyle{apalike2}%Change this to use a different bibliography
