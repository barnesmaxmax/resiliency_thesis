...
\begin{equation}
\begin{aligned}
	A_{jm} = \gamma_{jm off} * office_j + \gamma_{2_{j}} * C_2 + \gamma_{3_{j}} * C_{3}
	\label{eqn:sizeterm}
\end{aligned}
\end{equation}
...
\noindent where $\beta$ represents a coefficient, $d$ represents distance data,
...
The final calibration values  were presented in Table \ref{tab:coeffs}.
