...
AASHTO Class & \makecell{Minor \\Collectors} & \makecell{Minor \\Collectors} & \makecell{Minor \\Arterials} & \makecell{Principal \\Arterials} & \makecell{Interstate \\Expressway}\\
...
\citet{zhang2015.2} investigates the role of network topology, or the physical
...
\section{Changes in Accessibility}
\label{sec:cacc}
