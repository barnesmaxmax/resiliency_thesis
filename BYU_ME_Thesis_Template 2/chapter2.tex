...
\citet{aem2017} worked with UDOT to develop an I-15 Corridor Risk and Resilience
...
so-called gravity accessibility model with,
...
calibrated
impedance coefficient. This gravity accessibility term is often included in the
