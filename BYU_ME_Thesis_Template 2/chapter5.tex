...
not to eself: logsum is the total value of the choice set. the logsumi s the log of the denominator of the probability models. logsum is the benefit that people have from choice in a model.
